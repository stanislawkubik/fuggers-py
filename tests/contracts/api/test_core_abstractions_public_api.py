...
def test_core_option_and_underlying_traits_are_reachable_from_first_layer_rates_surface() -> None:
    assert HasExpiry.__module__ == "fuggers_py.rates.instruments"
    assert HasOptionType.__module__ == "fuggers_py.rates.instruments"
    assert HasUnderlyingInstrument.__module__ == "fuggers_py.rates.instruments"
