...
from fuggers_py.core.types import CashFlow, CashFlowSchedule, Currency, Date, Frequency
...
from fuggers_py.reference.bonds.types import AccruedConvention, BondIdentifiers, InflationIndexType, StubPeriodRules, YieldCalculationRules
from .fixed import _reference_period_bounds, _to_decimal

if TYPE_CHECKING:
    from fuggers_py.reference.inflation import InflationConvention, InflationIndexDefinition
...
class TipsBond(KindedInstrumentMixin, BondAnalytics, Bond):
    ...
    def reference_cpi(
        ...
        *,
        ...
        from fuggers_py.reference.inflation import reference_cpi as resolve_reference_cpi
    ...
    def index_ratio(
        ...
        *,
        ...
        from fuggers_py.reference.inflation import reference_index_ratio as resolve_reference_index_ratio
