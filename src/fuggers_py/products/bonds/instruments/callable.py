...
from fuggers_py.reference.bonds.types import BondIdentifiers, BondType, PutEntry, PutSchedule, PutType, YieldCalculationRules
from .fixed import FixedBond

if TYPE_CHECKING:
    from fuggers_py.pricers.bonds import BondPricer, StandardYieldEngine
...
class CallableBond(KindedInstrumentMixin, BondAnalytics, Bond):
    ...
    def yield_to_call(self, clean_price: object, settlement_date: Date, call_date: Date) -> Decimal:
        ...
        from fuggers_py.pricers.bonds import StandardYieldEngine
