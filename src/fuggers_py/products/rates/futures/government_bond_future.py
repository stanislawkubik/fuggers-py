...
from fuggers_py.core.ids import InstrumentId, YearMonth
from fuggers_py.products.instruments import KindedInstrumentMixin
from fuggers_py.reference.reference_data import BondFutureContractReference
...
def _coerce_frequency(value: Frequency | str) -> Frequency:
    """Coerce a frequency label into a :class:`~fuggers_py.core.types.Frequency`.
