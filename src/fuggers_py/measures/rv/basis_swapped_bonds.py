...
if TYPE_CHECKING:
    from fuggers_py.pricers.rates import BasisSwapPricingResult, CrossCurrencyBasisSwapPricingResult
...
def bond_to_common_currency_floating(
    ...
    *,
    ...
    from fuggers_py.pricers.rates import BasisSwapPricer, CrossCurrencyBasisSwapPricer
    from fuggers_py.pricers.rates.asset_swap import AssetSwapPricer
