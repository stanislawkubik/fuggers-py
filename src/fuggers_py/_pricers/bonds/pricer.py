...
from fuggers_py._core.compounding import CompoundingKind, CompoundingMethod
...
if TYPE_CHECKING:  # pragma: no cover
    from fuggers_py._products.bonds.instruments import TipsBond
...
@dataclass(frozen=True, slots=True)
class TipsPricer:
    """Real-yield pricer for :class:`~fuggers_py._products.bonds.instruments.TipsBond`.
