...
from fuggers_py._products.rates import CrossCurrencyBasisSwap, FloatingLegSpec
...
def _forward_rate_from_explicit_curve(curves: AnalyticsCurves, pair: CurrencyPair, date: Date) -> Decimal | None:
...
class CrossCurrencyBasisSwapPricer:
    ...
    def _pair_forward_rate(self, swap: CrossCurrencyBasisSwap, curves: AnalyticsCurves, date: Date) -> Decimal:
