...
from fuggers_py._measures.spreads import ParParAssetSwap, ProceedsAssetSwap, ReferenceRateBreakdown, reference_rate_decomposition
...
from fuggers_py._products.rates import AssetSwap
