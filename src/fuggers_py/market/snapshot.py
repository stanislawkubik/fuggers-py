...
Volatility surface records live in ``fuggers_py.market.vol_surfaces`` and are
re-exported here for compatibility with older imports.
"""
...
from fuggers_py.core.ids import CurrencyPair, CurveId, EtfId, InstrumentId, YearMonth
...
from .vol_surfaces import VolPoint, VolQuoteType, VolSurfaceType, VolatilitySurface
...
if TYPE_CHECKING:
    ...
    from .vol_surfaces import InMemoryVolatilitySource
