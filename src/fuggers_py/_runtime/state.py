...
state consumed by pricers and runtime workflows without mixing orchestration
with domain pricing code.
"""
...
if TYPE_CHECKING:
    from fuggers_py.curves import DiscountingCurve, RatesTermStructure
