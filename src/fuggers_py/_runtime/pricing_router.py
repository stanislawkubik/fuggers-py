"""Research-facing bond pricing router for the runtime layer.
...
from fuggers_py.bonds import BondPricer, BondRiskCalculator, KeyRateDurationCalculator
...
from fuggers_py.bonds.spreads import DiscountMarginCalculator
from fuggers_py.bonds.yields import current_yield, current_yield_from_bond
from fuggers_py.bonds.instruments import CallableBond, FixedBond, FloatingRateNote, TipsBond, ZeroCouponBond
from fuggers_py.bonds.options import HullWhiteModel
from fuggers_py.bonds import TipsPricer
from fuggers_py._core.types import Date, Price
from fuggers_py.curves.date_support import discount_factor_at_date, zero_rate_at_date
...
from fuggers_py._runtime.pricing_specs import PricingSpec, QuoteSide
...
class PricingRouter:
    ...
    def price_fixed(
        ...
        *,
        ...
        ytm_obj = BondPricer().yield_to_maturity(instrument, price, settlement_date)
        ytm = ytm_obj.value()
        ytw = self._yield_to_worst(instrument, clean_price, settlement_date, spec)
        risk = BondRiskCalculator(instrument, ytm_obj, settlement_date).all_metrics() if spec.compute_risk else None
    ...
    def _floating_rate_risk(
        ...
        *,
        ...
        bumped_up = AnalyticsCurves(
            discount_curve=base_curve.shifted(shift=bump),
            forward_curve=curves.forward_curve,
