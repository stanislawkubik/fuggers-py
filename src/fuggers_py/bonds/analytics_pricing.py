...
from fuggers_py.bonds import BondPricer as _BondPricer
from fuggers_py.bonds import TipsPricer as _TipsPricer
...
@dataclass(frozen=True, slots=True)
class BondPricer:
    """Analytics wrapper around :class:`fuggers_py.bonds.BondPricer`."""
...
@dataclass(frozen=True, slots=True)
class TipsPricer:
    """Analytics wrapper around :class:`fuggers_py.bonds.TipsPricer`."""
