...
if TYPE_CHECKING:
    from fuggers_py.rates.indices import BondIndex, IndexConventions, IndexFixingStore
...
def _accrued_convention_name(rules: YieldCalculationRules) -> str:
    convention = getattr(rules, "accrued_convention", None)
    value = getattr(convention, "value", convention)
    if not isinstance(value, str):
        raise InvalidBondSpec(reason="YieldCalculationRules.accrued_convention must be a string-like enum.")
    return value
...
class FloatingRateNote(KindedInstrumentMixin, BondAnalytics, Bond):
    ...
    _index_definition: object | None = None
    ...
    def new(
        ...
        *,
        ...
        index_definition: object | None = None,
        instrument_id: InstrumentId | None = None,
    ) -> "FloatingRateNote":
        return cls(
    ...
    def index_definition(self) -> object | None:
    ...
    def accrued_interest(
        ...
        *,
        ...
        for i in range(1, len(unadjusted)):
            ...
            if _accrued_convention_name(rules) == "EX_DIVIDEND":
...
class FloatingRateNoteBuilder:
    ...
    def with_index_definition(self, index_definition: object) -> "FloatingRateNoteBuilder":
