...
def haircut_adjustment_breakdown(
    *,
    ...
    haircut_amount = resolved_collateral_value * resolved_haircut
    drag_amount = haircut_amount * (resolved_haircut_funding_rate - resolved_repo_rate) * resolved_year_fraction
