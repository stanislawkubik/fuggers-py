...
class SwapPricer:
    ...
    def annuity(self, swap: FixedFloatSwap, curves: object) -> Decimal:
    ...
    def fixed_leg_pv(self, swap: FixedFloatSwap, curves: object) -> Decimal:
    ...
    def floating_leg_pv(self, swap: FixedFloatSwap, curves: object) -> Decimal:
    ...
    def par_rate(self, swap: FixedFloatSwap, curves: object) -> Decimal:
    ...
    def pv(self, swap: FixedFloatSwap, curves: object) -> Decimal:
    ...
    def price(self, swap: FixedFloatSwap, curves: object) -> SwapPricingResult:
