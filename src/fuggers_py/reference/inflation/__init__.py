...
This subpackage covers inflation-linked reference data, monthly CPI fixings,
reference-index interpolation, and Treasury TIPS metadata loaders. The public
surface is intentionally focused on normalized inputs and clear observation-lag
semantics.
"""
