...
from fuggers_py.market.snapshot import InflationFixing, InflationInterpolation, MarketDataSnapshot
from fuggers_py.market.sources import InflationFixingSource, MarketDataProvider
