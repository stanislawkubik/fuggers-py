"""Coupon schedule generation (`fuggers_py._products.bonds.cashflows.schedule`).
...
from fuggers_py._core.errors import ScheduleError
from fuggers_py._core import CalendarId
from fuggers_py._core.stub_rules import StubPeriodRules, StubType
