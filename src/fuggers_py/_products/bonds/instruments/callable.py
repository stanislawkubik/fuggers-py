...
from fuggers_py._reference.bonds.types import BondIdentifiers, PutEntry, PutSchedule, PutType
from .fixed import FixedBond

if TYPE_CHECKING:
    from fuggers_py._pricers.bonds import BondPricer, StandardYieldEngine
...
class CallableBond(KindedInstrumentMixin, BondAnalytics, Bond):
    ...
    def yield_to_call(self, clean_price: object, settlement_date: Date, call_date: Date) -> Decimal:
        ...
        from fuggers_py._pricers.bonds import StandardYieldEngine
