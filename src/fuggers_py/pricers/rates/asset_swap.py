...
from fuggers_py.measures.spreads import ParParAssetSwap, ProceedsAssetSwap, ReferenceRateBreakdown, reference_rate_decomposition
...
from fuggers_py.products.rates import AssetSwap
