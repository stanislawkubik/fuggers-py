...
from fuggers_py.reference.bonds.types import CompoundingKind, CompoundingMethod, YieldCalculationRules
...
if TYPE_CHECKING:  # pragma: no cover
    from fuggers_py.products.bonds.instruments import TipsBond
...
class PriceResult:
    ...
    :class:`~fuggers_py.core.types.Price` values in the bond currency. The
...
@dataclass(frozen=True, slots=True)
class TipsPricer:
    """Real-yield pricer for :class:`~fuggers_py.products.bonds.instruments.TipsBond`.
    ...
    quoted in percent of par unless wrapped in :class:`~fuggers_py.core.types.Price`.
    """
    ...
    def dirty_price_from_real_yield(
        ...
        *,
        ...
        The returned price is a currency-valued :class:`~fuggers_py.core.types.Price`.
        """
    ...
    def real_yield_from_clean_price(
        ...
        *,
        ...
        wrapped as a :class:`~fuggers_py.core.types.Yield` using the bond's
