...
Volatility surface source abstractions now have their public home in
``fuggers_py.vol_surfaces``. This module still re-exports them because market
state and snapshot objects depend on the same records.
"""
...
if TYPE_CHECKING:
    ...
    from fuggers_py.vol_surfaces import InMemoryVolatilitySource, VolatilitySource, VolatilitySurface
