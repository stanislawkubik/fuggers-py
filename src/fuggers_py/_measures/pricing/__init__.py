...
from fuggers_py._pricers.bonds import TipsPricer as _TipsPricer
...
@dataclass(frozen=True, slots=True)
class BondPricer:
    """Analytics wrapper around :class:`fuggers_py._pricers.bonds.BondPricer`."""
...
@dataclass(frozen=True, slots=True)
class TipsPricer:
    """Analytics wrapper around :class:`fuggers_py._pricers.bonds.TipsPricer`."""
