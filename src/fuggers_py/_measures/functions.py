...
from fuggers_py._products.bonds.cashflows.accrued import AccruedInterestCalculator, AccruedInterestInputs
from fuggers_py._products.bonds.traits import Bond
from fuggers_py._core import YieldCalculationRules
from fuggers_py._core.compounding import CompoundingKind
from fuggers_py._core.yield_convention import YieldConvention
from fuggers_py._core.daycounts import DayCountConvention
from fuggers_py._core.types import Compounding, Date, Price, Yield
...
def yield_to_maturity(bond: Bond, price: Price, settlement_date: Date) -> Yield:
    ...
    bond:
        Bond to value.
    price:
        Clean price expressed as a :class:`~fuggers_py._core.types.Price`.
    settlement_date:
...
def yield_to_maturity_with_convention(
    ...
    Notes
    -----
    For :attr:`~fuggers_py._reference.bonds.types.YieldConvention.STREET_CONVENTION`,
