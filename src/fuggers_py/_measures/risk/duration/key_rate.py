"""Key-rate duration helpers (`fuggers_py._measures.risk.duration.key_rate`).
...
from fuggers_py._market.curve_support import STANDARD_KEY_RATE_TENORS, key_rate_bumped_curve
